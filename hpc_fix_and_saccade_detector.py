    ...
    def submit_job_array(self, job_file_path):
        ...
        try:
            ...
            result = subprocess.run(
                f'sbatch --job-name=fix_dsq --output={self.job_script_out_dir}/fixation_session_%a.out '
                f'--error={self.job_script_out_dir}/fixation_session_%a.err {job_script_path}',
